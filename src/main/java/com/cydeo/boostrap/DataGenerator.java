...
@Service // same as @Component - creates bean
public class DataGenerator implements CommandLineRunner {

    private final RoleService roleService; // go to RoleServiceImpl and put @Component class
...
/*        // how to add to Map
        ...
        rs.save(adminRole); // this is add to map, but,


        RoleService rs2 = new RoleServiceImpl();
        rs.save(adminRole);  // but it is tight coupling*/
